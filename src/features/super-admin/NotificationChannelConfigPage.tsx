...
const LABELS: Record<string, string> = {
  ...
  complaint_in_review: 'Report picked up by the support team (to the student)',
  complaint_resolved: 'Report resolved, with the outcome (to the student)',
  case_in_dispute: 'Case paused for review (to the student)',
  case_paused: 'Case paused for review (to the consultancy)',
  case_dispute_raised: 'A consultancy raised an issue on a case (Sentpo staff)',
  case_resumed: 'Case active again after a review (to the student)',
  ...
  course_suggestion_reviewed: 'Course or college suggestion accepted or rejected (to who suggested it)',
  consultancy_assigned: 'Student told which consultancy they are now with',
  event_reminder: 'Event reminder (a day and 15 minutes before)',
  event_changed: 'Event time, venue or link changed',
