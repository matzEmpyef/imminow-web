  ...
  return (
    <>
      <button
        ...
        onClick={toggleOpen}
        className={`flex h-10 items-center gap-xs rounded-md border px-3 text-body-sm transition-colors ${
          active
          ...
          {options.length > SEARCH_THRESHOLD && (
            <div className="border-b border-border p-sm">
              <input
                ...
                className="h-8 w-full rounded-md border border-border bg-background px-sm text-body-sm text-text-primary outline-none focus:border-primary"
              />
            </div>
          )}
